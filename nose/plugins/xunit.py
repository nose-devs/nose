...
class Xunit(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            '--test-suite-name', action='store',
            dest='test_suite_name', metavar="PACKAGE",
            default=env.get('NOSE_TEST_SUITE_NAME', 'nosetests'),
    ...
    def configure(self, options, config):
        ...
        if self.enabled:
            ...
            self.test_suite_name = options.test_suite_name
    ...
    def report(self, stream):
        ...
        self.error_report_file.write(
            ...
            u'<testsuite name="' + self.test_suite_name + u'" tests="%(total)d" '
